  ...
  for await (const line of rl) {
    try {
      ...
      if (parsed.type === 'USER_INPUT' && parsed.content.includes('danger zone')) {
        fs.writeFileSync('C:/Users/zozoo/.gemini/antigravity/brain/ababa079-367a-4a6b-a1b5-9bb6d141af0b/scratch/user_request.txt', parsed.content);
        console.log('Found and written to scratch.');
      }
    } catch(e) {}
  }
}
