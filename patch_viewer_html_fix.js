...
const paths = [
  'f:/code/eva/evaprojectmultiplatforme/EVA_V4_fixed_v4/chat.html',
  'f:/code/eva/evaprojectmultiplatforme/eva-pc/web/chat.html'
];
...
paths.forEach(p => {
  if (fs.existsSync(p)) {
    ...
    let endIdx = html.indexOf('</div>', html.indexOf('<img id="imageViewerContent"'));
