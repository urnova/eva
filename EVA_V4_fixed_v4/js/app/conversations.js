...
function renderConvs(filter) {
  ...
  var _svgPin  = '<svg viewBox="0 0 24 24"><path d="M16 11V7a4 4 0 0 0-8 0v4l-2 4h12z"/><path d="M12 15v6"/></svg>';

  list.innerHTML = convs.map(function(c) {
    var act = c.id === S.convId;
    var pinIcon = c.isPinned ? '<div style="position:absolute;top:5px;right:5px;color:#f39c12;width:12px;height:12px;">'+_svgPin+'</div>' : '';
